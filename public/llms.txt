...
```mermaid
flowchart LR
  idea[Idea] --> spec[Short spec]
  spec --> cursor[Cursor/Claude Code]
  cursor --> pr[PR or direct main]
  pr --> vercel[Vercel deploy]
  vercel --> demo[Share URL]
```
